    ...
    <div class="container" > 
        ...
        <table>
            <tr>
                ...
                <td style="font-size: 17px">Uniwersytet Rzeszowski kieruje do w/w instytucji studenta(ów) Kolegium Nauk <b>Przyrodniczych</b>, kierunek <b>{{ $firstActive->code->direction->name }}</b> w celu odbycia programowej praktyki zawodowej, według poniższego/dołączonego harmonogramu.</td>
            </tr>
        </table>
        <br/>
